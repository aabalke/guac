...
func NewAddrPointer(parent Component, layout Layout, prefix string, address uint32, fontSize int, color, colorAlt sdl.Color, positionMethod string) *AddrPointer {
...
func (b *AddrPointer) Update(event sdl.Event) bool {
...
func (b *AddrPointer) View() {
    ...
    b.currText = fmt.Sprintf(
        "%s: %08X %08X %08X %08X %08X %08X %08X %08X",
        b.prefix,
        Gba.Mem.Read32(b.Address),
        Gba.Mem.Read32(b.Address + 4),
        Gba.Mem.Read32(b.Address + 8),
        Gba.Mem.Read32(b.Address + 12),

        Gba.Mem.Read32(b.Address + 16),
        Gba.Mem.Read32(b.Address + 20),
        Gba.Mem.Read32(b.Address + 24),
        Gba.Mem.Read32(b.Address + 28),
    )
...
func (b *AddrPointer) Add(c Component) {
	b.children = append(b.children, &c)
}

func (b *AddrPointer) Resize() {
...
func (b *AddrPointer) GetChildren() []*Component {
	return b.children
}

func (b *AddrPointer) GetParent() *Component {
	return b.parent
}

func (b *AddrPointer) GetLayout() *Layout {
	return &b.Layout
}

func (b *AddrPointer) GetStatus() Status {
	return b.Status
}

func (b *AddrPointer) SetChildren(c []*Component) {
	b.children = c
}

func (b *AddrPointer) SetStatus(s Status) {
	b.Status = s
}

func (b *AddrPointer) SetLayout(l Layout) {
	b.Layout = l
}

func (b *AddrPointer) UpdateText(s uint32) {
	b.Address = s
	b.Dirty = true
	b.View()
}
func (b *AddrPointer) GetRenderer() *sdl.Renderer {
	return b.Renderer
}

func (b *AddrPointer) RenderText() {
