...
func (s *Screen) ApplyTouchPositions(x, y, w, h int) {
    switch s.Rotation {
    case ROT_0:   s.BtmAbs = BtmAbs{T: y, B: y + h, L: x, R: x + w, W: w, H: h}
    case ROT_90:  s.BtmAbs = BtmAbs{L: y, R: y + w, B: x, T: x + h, H: w, W: h}
    case ROT_180: s.BtmAbs = BtmAbs{B: y, T: y + h, R: x, L: x + w, W: w, H: h}
    case ROT_270: s.BtmAbs = BtmAbs{R: y, L: y + w, T: x, B: x + h, H: w, W: h}
    default:
