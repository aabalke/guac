...
func (e *ExMem) Write(v uint8, b uint8) {
	...
	switch b {
	case 0:
		e.isGBAAccessArm7 = (v>>7)&1 != 0
	case 1:
		e.isCartAccessArm7 = (v>>3)&1 != 0
		e.isMainMemorySync = (v>>6)&1 != 0
		e.isMainMemoryPriorityArm7 = (v>>7)&1 != 0
	}
}
...
func (a *AuxSPI) Write(v uint8, b uint8, arm9 bool) {
	...
	case 1:
		...
		a.IsBackup = (v>>5)&1 != 0
		a.Gamecard.RomTransferIrq = (v>>6)&1 != 0
		a.Gamecard.NDSSlotEnabled = (v>>7)&1 != 0
